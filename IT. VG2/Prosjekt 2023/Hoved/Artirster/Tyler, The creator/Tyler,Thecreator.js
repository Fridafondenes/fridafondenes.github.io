...
fetch("https://spotify81.p.rapidapi.com/search?q=Tyler,Thecreator&type=multi&offset=0&limit=10&numberOfTopResults=5", options)
...
function behandleSvar(svar){
  ...
  // for (let i = 0; i < svar.artists.items.length; i++) {
